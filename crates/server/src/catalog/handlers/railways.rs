...
pub async fn get_railway_by_id(railway_id: web::Path<RailwayId>, _db_pool: web::Data<PgPool>) -> impl Responder {
    println!("{}", railway_id);
    HttpResponse::Ok()
}
...
pub async fn delete_railway(railway_id: web::Path<RailwayId>, _db_pool: web::Data<PgPool>) -> impl Responder {
    println!("{}", railway_id);
    HttpResponse::Ok()
}
